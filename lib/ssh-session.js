    ...
    return new Promise((resolve, reject) => {
        ...
        if (this.stun || this.turn) {
            ...
            firstCall = this.unifi.getTurnCredentials().then((data) => {
                ...
                return this.unifi.buildSSHSession(this.mac, this.uuid, "-1", (this.stun ? this.stun[0] : undefined), (this.turn ? this.turn[0] : undefined), this.username, this.password, this.site);
