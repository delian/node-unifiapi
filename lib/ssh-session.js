//let webrtc = require('electron-webrtc')({ headless: true });
...
SSHSession.prototype.connect = function(connectTimeout) {
    return new Promise((resolve, reject) => {
        ...
        if (this.stun || this.turn) {
            ...
            firstCall = this.unifi.getTurnCredentials().then((data) => {
                ...
                return this.unifi.buildSSHSession(this.mac, this.uuid, "-1", (this.stun ? this.stun[0].replace(/stun:/, '') : undefined), (this.turn ? this.turn[0].replace(/turn:/, '') : undefined), this.username, this.password, this.site);
                //return this.unifi.buildSSHSession(this.mac, this.uuid, "-1", undefined, undefined, undefined, undefined, this.site);
            });
        }
        firstCall.then(() => {
                this.wrtc = new wrtc({ debug: this.debug /*, wrtc: webrtc*/ });
                ...
                let connStateChange = () => {
                    ...
                    if (['open', 'failed', 'error', 'disconnected', 'connected'].indexOf(state) < 0) {
