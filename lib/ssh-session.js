    ...
    return new Promise((resolve, reject) => {
        ...
        if (this.stun || this.turn) {
            ...
            firstCall = this.unifi.getTurnCredentials().then((data) => {
                ...
                if (data && data.data && data.data.uris) {
                ...
                return this.unifi.buildSSHSession(this.mac, this.uuid, "-1", (this.stun || []).shift(), (this.turn || []).shift(), this.username, this.password, this.site);
