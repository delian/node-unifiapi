...
class WRTC {
    ...
    RTCPeerConnection(options, conditions) {
        ...
        this.peer = new this.wrtc.RTCPeerConnection(options, conditions);
        [
        ...
        return new Promise((resolve, reject) => {
            ...
            wait(waiter).then(() => {
                this.peer.setLocalDescription(
                    new this.wrtc.RTCSessionDescription(desc),
                    (data) => {
    ...
    setRemoteDescription(desc) {
        return new Promise((resolve, reject) => {
            ...
            let w = new this.wrtc.RTCSessionDescription(desc);
            wait(undefined, waiter).then(() => {
